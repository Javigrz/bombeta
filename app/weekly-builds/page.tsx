  ...
  const products = [
    {
      ...
      momentumHistory: [650, 680, 720, 780, 820, 840, 847]
    },
    {
      id: "2",
      rank: 2,
      ...
      momentumHistory: [450, 480, 520, 580, 600, 620, 632]
    },
    {
      id: "3",
      rank: 3,
      ...
      momentumHistory: [320, 360, 420, 480, 500, 510, 524]
    },
    {
      id: "4",
      rank: 4,
      ...
      momentumHistory: [100, 120, 140, 160, 170, 180, 189]
    },
    {
      id: "5", 
      rank: 5,
      ...
      momentumHistory: [80, 90, 100, 120, 130, 140, 145]
    },
    {
      id: "6",
      rank: 6,
      ...
      description: "Beautiful Kanban boards and Gantt charts that make project management intuitive. Real-time collaboration with team members, automated progress tracking, and smart deadline predictions.",
      momentum: 87,
      momentumChange: 32,
      category: ["Project Management", "Team Collaboration", "Productivity"],
      makers: ["Lisa Wang", "David Kim"],
      band: "fresh" as const,
      sparklineData: [40, 45, 55, 65, 75, 80, 87],
      momentumHistory: [40, 45, 55, 65, 75, 80, 87]
    },
    {
      id: "7",
      rank: 7,
      ...
      description: "Create stunning visualizations from CSV, JSON, or live APIs. Interactive dashboards with 50+ chart types, real-time updates, and seamless embedding capabilities.",
      momentum: 65,
      momentumChange: 15,
      category: ["Data Visualization", "Analytics", "Dashboard"],
      makers: ["Carlos Rodriguez"],
      band: "fresh" as const,
      sparklineData: [30, 35, 40, 50, 55, 60, 65],
      momentumHistory: [30, 35, 40, 50, 55, 60, 65]
    }
  ]
...
// Simple Podium card component - NO entrance animations
      ...
      <div className={`p-6 rounded-xl border transition-all duration-200 cursor-pointer ${
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            {/* Rank */}
            <div className="flex items-center gap-2 md:gap-3 md:min-w-[100px]">
              <span className="font-inter text-xl md:text-2xl font-bold text-[#FAF5EB]">
                {product.rank}.
              </span>
            </div>
          ...
          {(isHovered || isFocused) && product.description && (
            ...
            >
              ...
              {product.makers && product.makers.length > 0 && (
                <div className="mb-3">
                  <span className="font-inter text-xs text-[#FAF5EB]/40 uppercase tracking-wider">By</span>
                  <div className="flex flex-wrap gap-2 mt-1">
                    {product.makers.map(maker => (
                      <span key={maker} className="font-inter text-xs text-[#FE4629]/80">
                        {maker}
                      </span>
                    ))}
                  </div>
            ...
            <div className="flex-1">
              ...
              {(isHovered || isFocused) && product.description && (
                ...
                >
                  ...
                  {product.makers && product.makers.length > 0 && (
                    <div className="mb-3">
                      <span className="font-inter text-xs text-[#FAF5EB]/40 uppercase tracking-wider">Makers</span>
                      <div className="flex flex-wrap gap-2 mt-1">
                        {product.makers.map(maker => (
                          <span key={maker} className="font-inter text-xs text-[#FE4629]/80">
                            {maker}
                  ...
                  {/* Categories */}
                  <div className="mb-2">
                    <span className="font-inter text-xs text-[#FAF5EB]/40 uppercase tracking-wider">Categories</span>
                    <div className="flex flex-wrap gap-2 mt-1">
                      {product.category?.map(cat => (
                        <span key={cat} className="px-2 py-1 bg-[#FAF5EB]/10 rounded-md font-inter text-xs text-[#FAF5EB]/80">
                          {cat}
                  ...
                  {product.momentumChange && (
                    <div className="flex items-center gap-2">
                      <span className="font-inter text-xs text-[#FAF5EB]/40 uppercase tracking-wider">Growth</span>
                      <span className="font-inter text-xs text-green-400">
                        +{product.momentumChange} momentum this week
                      </span>
                    </div>
                  )}
                </div>
